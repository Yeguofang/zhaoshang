<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:62:"D:\Project\zhaoshang\public/template/pc/project/list/10/1.html";i:1573636968;}*/ ?>
<!DOCTYPE html>
            ...
            <div class="left">
                ...
                <div class="box">
                    <div class="boxbigclass">
                                                <li><a href="/project/10/92">家政</a></li>
                                                <li><a href="/project/10/93">家政服务</a></li>
                                                <li><a href="/project/10/94">摄影</a></li>
                                                <li><a href="/project/10/95">家电清洗</a></li>
                                                <li><a href="/project/10/96">足疗美甲</a></li>
                                                <li><a href="/project/10/97">美容美发</a></li>
                                                <li><a href="/project/10/98">视力保健</a></li>
                                                <li><a href="/project/10/99">健身房</a></li>
                                                <li id="more">显示更多...</li>
                    </div>
                </div>
    ...
    <script type=text/javascript>
        $(function() {  
            ...
            $("#redirect").click(function(){
              var page = $("#pages").val();
              console.log(page)
              window.location.href = "/project/10/99?page="+page;
            });
