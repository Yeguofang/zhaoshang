<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:76:"D:\Project\zhaoshang\public/../application/index\view\menber\user\login.html";i:1573181073;s:60:"D:\Project\zhaoshang\application\index\view\common\head.html";i:1573180526;s:62:"D:\Project\zhaoshang\application\index\view\common\footer.html";i:1573202891;}*/ ?>
...
<div id="content-container" class="container">
    <div class="user-section login-section">
        <div class="logon-tab clearfix"> <a class="active"><?php echo __('Sign in'); ?></a> <a href="<?php echo url('menber/user/register'); ?>"><?php echo __('Sign up'); ?></a> </div>
        <div class="login-main">
            <form name="form" id="login-form" class="form-vertical" method="POST" action="">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="captcha" class="form-control input-lg" placeholder="验证码" data-rule="<?php echo __('Captcha'); ?>:required;length(4)" />
                    <span class="input-group-addon" style="padding:0;border:none;cursor:pointer;">
                        <img src="<?php echo rtrim('/', '/'); ?>/index.php?s=/captcha" width="100" height="40" onclick="this.src='<?php echo rtrim('/', '/'); ?>/index.php?s=/captcha&r=' + Math.random();"/>
                    </span>
                </div>
                <div class="form-group">
                    <div class="controls">
