<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"D:\Project\zhaoshang\public/template/pc/project/list/1/15/1.html";i:1573705701;}*/ ?>
<!DOCTYPE html>
    ...
    <script type=text/javascript>
        $(function() {  
            ...
            $("#redirect").click(function(){
              var page = $("#pages").val();
              console.log(page)
              window.location.href = "/project/1/42?page="+page;
            });
