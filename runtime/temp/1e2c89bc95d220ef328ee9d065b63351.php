<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:63:"D:\Project\zhaoshang\public/template/pc/project/list/101/1.html";i:1573636107;}*/ ?>
<!DOCTYPE html>
            ...
            <div class="left">
                ...
                <div class="box">
                    <div class="boxbigclass">
                                                <li><a href="/project/101/102">VR体验馆</a></li>
                                                <li><a href="/project/101/103">KTV</a></li>
                                                <li><a href="/project/101/104">影院</a></li>
                                                <li><a href="/project/101/105">网吧</a></li>
                                                <li id="more">显示更多...</li>
                    </div>
                </div>
    ...
    <script type=text/javascript>
        $(function() {  
            ...
            $("#redirect").click(function(){
              var page = $("#pages").val();
              console.log(page)
              window.location.href = "/project/101/105?page="+page;
            });
