<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:63:"D:\Project\zhaoshang\public/template/pc/project/list/106/1.html";i:1573636959;}*/ ?>
<!DOCTYPE html>
            ...
            <div class="left">
                ...
                <div class="box">
                    <div class="boxbigclass">
                                                <li><a href="/project/106/107">饰品</a></li>
                                                <li><a href="/project/106/108">礼品</a></li>
                                                <li><a href="/project/106/109">首饰</a></li>
                                                <li><a href="/project/106/110">珠宝</a></li>
                                                <li><a href="/project/106/111">佛教用品</a></li>
                                                <li id="more">显示更多...</li>
                    </div>
                </div>
    ...
    <script type=text/javascript>
        $(function() {  
            ...
            $("#redirect").click(function(){
              var page = $("#pages").val();
              console.log(page)
              window.location.href = "/project/106/111?page="+page;
            });
