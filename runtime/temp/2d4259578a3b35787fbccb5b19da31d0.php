<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:62:"D:\Project\zhaoshang\public/template/pc/project/list/34/1.html";i:1573636962;}*/ ?>
<!DOCTYPE html>
            ...
            <div class="left">
                ...
                <div class="box">
                    <div class="boxbigclass">
                                                <li><a href="/project/34/43">婴儿游泳</a></li>
                                                <li><a href="/project/34/44">儿童乐园</a></li>
                                                <li><a href="/project/34/45">母婴用品</a></li>
                                                <li><a href="/project/34/46">月子中心</a></li>
                                                <li><a href="/project/34/47">儿童玩具</a></li>
                                                <li><a href="/project/34/48">儿童摄影</a></li>
                                                <li><a href="/project/34/49">儿童手工</a></li>
                                                <li><a href="/project/34/50">儿童推拿</a></li>
                                                <li><a href="/project/34/51">产后恢复</a></li>
                                                <li id="more">显示更多...</li>
                    </div>
                </div>
    ...
    <script type=text/javascript>
        $(function() {  
            ...
            $("#redirect").click(function(){
              var page = $("#pages").val();
              console.log(page)
              window.location.href = "/project/34/51?page="+page;
            });
