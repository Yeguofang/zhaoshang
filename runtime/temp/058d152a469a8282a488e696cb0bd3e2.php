                        ...
                        <tr>
                            <td width="33%" align="center">
                                <table width="300" height="300" border="0" cellpadding="5" cellspacing="1" bgcolor="dddddd">
                                    <tr>
                                        <td align="center" bgcolor="#FFFFFF"><img src='<?php echo $data['image']; ?>' style="width: 100%;"/></td>
                                    </tr>
                                </table>
                            </td>
                            <td width="67%">
