<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"D:\Project\zhaoshang\public/../application/index\view\menber\project\list.html";i:1572765525;s:67:"D:\Project\zhaoshang\application\index\view\menber\common\head.html";i:1572765525;}*/ ?>
<!DOCTYPE html>
...
<script type="text/html" id="toolbarDemo">
  ...
  <button class="layui-btn" onclick="xadmin.open('发布项目','<?php echo url('menber/project/add'); ?>')" >发布项目</button>
  <button class="layui-btn layui-btn-danger" lay-event="getCheckData">批量删除</button>
  </div>
</script>

<script type="text/html" id="barDemo">
  <a class="layui-btn layui-btn-xs" lay-event="edit" onclick="xadmin.open('发布文章','<?php echo url('menber/project/edit'); ?>/{{d.id}}')">编辑</a>
