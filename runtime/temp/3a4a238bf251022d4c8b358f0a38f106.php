...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                <label class="control-label col-xs-12 col-sm-2"><?php echo __('tdk-标题'); ?>:</label>
                <div class="col-xs-12 col-sm-8">
            ...
            <div class="form-group">
                <label class="control-label col-xs-12 col-sm-2"><?php echo __('tdk-关键字'); ?>:</label>
                <div class="col-xs-12 col-sm-8">
            ...
            <div class="form-group">
                <label class="control-label col-xs-12 col-sm-2"><?php echo __('tdk-描述'); ?>:</label>
                <div class="col-xs-12 col-sm-8">
