<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:62:"D:\Project\zhaoshang\public/template/pc/project/list/31/1.html";i:1573636967;}*/ ?>
<!DOCTYPE html>
            ...
            <div class="left">
                ...
                <div class="box">
                    <div class="boxbigclass">
                                                <li><a href="/project/31/79">早教</a></li>
                                                <li><a href="/project/31/80">幼儿园</a></li>
                                                <li><a href="/project/31/81">教育培训</a></li>
                                                <li><a href="/project/31/82">英语培训</a></li>
                                                <li><a href="/project/31/83">少儿编程</a></li>
                                                <li><a href="/project/31/84">美术教育</a></li>
                                                <li><a href="/project/31/85">国学馆</a></li>
                                                <li id="more">显示更多...</li>
                    </div>
                </div>
    ...
    <script type=text/javascript>
        $(function() {  
            ...
            $("#redirect").click(function(){
              var page = $("#pages").val();
              console.log(page)
              window.location.href = "/project/31/85?page="+page;
            });
