<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"/var/www/zs/public/../application/index/view/menber/article/list.html";i:1572419925;s:58:"/var/www/zs/application/index/view/menber/common/head.html";i:1571803846;}*/ ?>
<!DOCTYPE html>
...
<script type="text/html" id="toolbarDemo">
  ...
  <button class="layui-btn" onclick="xadmin.open('发布文章','<?php echo url('menber/article/add'); ?>',900,800)" >发布文章</button>
  <button class="layui-btn layui-btn-danger" lay-event="getCheckData">批量删除</button>
  </div>
</script>

<script type="text/html" id="barDemo">
  <a class="layui-btn layui-btn-xs" lay-event="edit" onclick="xadmin.open('发布文章','<?php echo url('menber/article/edit'); ?>/{{d.id}}',900,800)">编辑</a>
