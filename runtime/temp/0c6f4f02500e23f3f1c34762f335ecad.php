        ...
        <div id="myTabContent" class="tab-content">
            <div class="tab-pane fade active in" id="one">
                ...
                <div class="row">
                    ...
                    <?php if(is_array($today) || $today instanceof \think\Collection || $today instanceof \think\Paginator): $i = 0; $__LIST__ = $today;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$t): $mod = ($i % 2 );++$i;?>
                    <div class="col-lg-2">
                            ...
                            <div class="card-block">
                                <div class="row row-sm stats-container">
                                    <div class="col-xs-12 stat-col">
                                        ...
                                        <div class="stat">
                                            <div class="value"><?php echo $t[0]; ?></div>
                                            <div class="name"><?php echo $t[2]; ?></div>
                                        </div>
                                        <div class="progress">
                                    ...
                                    <div class="col-xs-12 stat-col">
                                            <div class="stat-icon"><i class="fa fa-home"></i></div>
                                            <div class="stat">
                                                <div class="value"><?php echo $t[1]; ?></div>
                                                <div class="name"><?php echo $t[3]; ?></div>
                                            </div>
                                            <div class="progress">
                                                <div class="progress-bar progress-bar-success" style="width: 30%"></div>
                                            </div>
                ...
                <div class="row">
                        ...
                        <div class="box box-success">
                            ...
                            <div class="box-body">
                                <ul class="nav nav-pills nav-stacked">
                                    ...
                                    <li>
                                        <h4><?php echo $c['name']; ?><span class="pull-right text-red"><?php echo $c['sum']; ?></span></h4>
                                    </li>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                </ul>
                            </div>
                    ...
                    <div class="col-lg-2">
                            <div class="box box-success">
                                ...
                                <div class="box-body">
                                    <ul class="nav nav-pills nav-stacked">
                                        <?php if(is_array($art_data) || $art_data instanceof \think\Collection || $art_data instanceof \think\Paginator): $i = 0; $__LIST__ = $art_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$c): $mod = ($i % 2 );++$i;?>
                                        <li>
                                            <h4><?php echo $c['name']; ?><span class="pull-right text-red"><?php echo $c['sum']; ?></span></h4>
                                        </li>
                                        <?php endforeach; endif; else: echo "" ;endif; ?>
