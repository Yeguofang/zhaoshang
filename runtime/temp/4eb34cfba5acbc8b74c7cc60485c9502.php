        ...
        <div class="pagebody">
          ...
          [关闭该页]</a>
                ...
                <div class="content1">
                    ...
                    匿名网友：<?php echo $c['content']; endforeach; endif; else: echo "" ;endif; endif; ?>
                </div>
                <div class="titles">
                    <h3>发表评论</h3>
                </div>
