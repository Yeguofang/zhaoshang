<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:71:"D:\Project\zhaoshang\public/../application/admin\view\project\edit.html";i:1573284447;s:63:"D:\Project\zhaoshang\application\admin\view\layout\default.html";i:1572765525;s:60:"D:\Project\zhaoshang\application\admin\view\common\meta.html";i:1572765525;s:62:"D:\Project\zhaoshang\application\admin\view\common\script.html";i:1572765525;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="form-group">
                <label class="control-label col-xs-12 col-sm-2">加盟电话</label>
                <div class="col-xs-12 col-sm-8">
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                <label class="control-label col-xs-12 col-sm-2">招商地区</label>
                <div class="col-xs-12 col-sm-8">
            ...
            <div class="form-group">
                    <label class="control-label col-xs-12 col-sm-2">所在地区</label>
                    <div class="col-xs-12 col-sm-8">
                        <div class="form-inline" data-toggle="cxselect" data-selects="parentid,shi">
                            <select class="parentid form-control" name="parentid">
                                <option value="">请选择</option>
            ...
            <div class="form-group">
                    <label class="control-label col-xs-12 col-sm-2">tdk-标题</label>
                    <div class="col-xs-12 col-sm-8">
            ...
            <div class="form-group">
                <label class="control-label col-xs-12 col-sm-2">海报</label>
                <div class="col-xs-12 col-sm-8">
