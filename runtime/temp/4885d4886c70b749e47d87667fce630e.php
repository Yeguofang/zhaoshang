            ...
            <div class="left">
                <div class="box">
                    ...
                    <div id="BoxInfoTitleNext">
                      发布日期：<?php echo date('Y-m-d',$data['createtime']); ?> &nbsp;&nbsp; &nbsp;&nbsp;来源：<a href="/"><?php echo $web['web_name']; ?></a> &nbsp;&nbsp;共阅<?php echo $data['views']; ?>次  字体：<a href='javascript:fontZoom(22)'>大</a> <a href='javascript:fontZoom(14)'>中</a> <a href='javascript:fontZoom(12)'>小</a>
                    </div>
                    <div id="fontzoom">
