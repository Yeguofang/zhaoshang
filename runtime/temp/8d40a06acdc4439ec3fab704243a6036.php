<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:61:"D:\Project\zhaoshang\public/../application/template/help.html";i:1573292233;}*/ ?>
<!--
 * @Descripttion: 
 * @Author: Jason
...
<head>
    ...
    <title>创业帮助_991创业商机网</title>
    <meta content="" name="description" />
    <meta content="创业帮助" name="keywords" />
...
<body>
    <div class="main">
        ...
        <div class="bordercccccc" style="margin-bottom:10px">
            ...
            <div style="zoom: 1; overflow:auto;padding:10px">
                <ul>
                        ...
                        <A href="/help#3">大是大非</A>
                    </LI>
                                        <LI style="float:left;width:500px">【帮助】
                        <A href="/help#4">项目留言</A>
                    </LI>
                                        <LI style="float:left;width:500px">【帮助】
                        <A href="/help#6">项目留言</A>
                    </LI>
                                        <LI style="float:left;width:500px">【帮助】
                        <A href="/help#7">回收站</A>
                    </LI>
                                        <LI style="float:left;width:500px">【帮助】
                        <A href="/help#8">永久删除</A>
                    </LI>
                                    </ul>
            </div>
        </div>
        ...
        <div class="content1">
            <p>
           <p><img src="/ueditor/php/upload/image/20191031/1572504592752811.png" title="1572504592752811.png" alt="屏幕截图_4.png"/></p>            </p>
        </div>
                <div class="titles"><span><a href="#ding">↑返回到顶部</a></span>
            <a name="4"></a>
            <h3>项目留言</h3>
