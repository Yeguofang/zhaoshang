<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"D:\Project\zhaoshang\public/../application/index\view\menber\project\add.html";i:1572765525;s:67:"D:\Project\zhaoshang\application\index\view\menber\common\head.html";i:1572765525;}*/ ?>
<!DOCTYPE html>
        ...
        <div class="layui-row">
            <form class="layui-form">
                ...
                <div class="layui-form-item layui-form-text">
                        <label for="desc" class="layui-form-label">海报</label>
                        <div class="layui-input-block">
                            <!-- 加载编辑器的容器 -->
                            <script id="poster" name="poster"" type="text/plain"></script>
                        </div>
                    </div>
        ...
        layui.use(['form', 'layer', 'upload'],
            function () {
                ...
                var editor = UE.getEditor('container');
                  // 实例化海报编辑器 
                var poster_ed = UE.getEditor('poster');

                //监听提交
                form.on('submit(add)', function (data) {
                    //文本编辑器内容
                    data.field.content = editor.getContent();
                    data.field.poster = poster_ed.getContent();
