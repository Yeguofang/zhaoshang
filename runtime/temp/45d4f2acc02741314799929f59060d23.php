<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:76:"D:\Project\zhaoshang\public/../application/admin\view\general\web\index.html";i:1572765525;s:63:"D:\Project\zhaoshang\application\admin\view\layout\default.html";i:1572765525;s:60:"D:\Project\zhaoshang\application\admin\view\common\meta.html";i:1572765525;s:62:"D:\Project\zhaoshang\application\admin\view\common\script.html";i:1572765525;}*/ ?>
<!DOCTYPE html>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td> 百度统计代码</td>
                                    <td>
                                        <textarea name="row[web_baidu]]" class="form-control" rows="5"><?php echo $date->web_baidu; ?></textarea>
                                    </td>
                                    <td></td>
                                </tr>
                            </tbody>
                    ...
                    <form id="web-form" class="edit-form form-horizontal" role="form" data-toggle="validator" method="POST" action="<?php echo url('general.web/tdk'); ?>">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td> <?php echo $t['name']; ?>-description</td>
                                    <td>
                                        <input type="text" name="row[<?php echo $t['id']; ?>][description]" value="<?php echo $t['description']; ?>" class="form-control" data-rule="" />
                                    </td>
                                    <td></td>
                                </tr>
                                <tr>
