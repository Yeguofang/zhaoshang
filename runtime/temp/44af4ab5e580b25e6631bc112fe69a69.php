<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:62:"D:\Project\zhaoshang\public/template/pc/project/list/33/1.html";i:1573636990;}*/ ?>
<!DOCTYPE html>
            ...
            <div class="left">
                ...
                <div class="box">
                    <div class="boxbigclass">
                                                <li><a href="/project/33/52"> 便利店</a></li>
                                                <li><a href="/project/33/53">零食店</a></li>
                                                <li><a href="/project/33/54">渔具</a></li>
                                                <li><a href="/project/33/55">啤酒</a></li>
                                                <li><a href="/project/33/56">茶叶</a></li>
                                                <li><a href="/project/33/57">零售百货</a></li>
                                                <li><a href="/project/33/58">超市</a></li>
                                                <li><a href="/project/33/59">红酒</a></li>
                                                <li><a href="/project/33/60">药店</a></li>
                                                <li><a href="/project/33/61">水果店</a></li>
                                                <li><a href="/project/33/62">文具店</a></li>
                                                <li><a href="/project/33/63">书店</a></li>
                                                <li><a href="/project/33/64">眼镜</a></li>
                                                <li><a href="/project/33/65">牛奶</a></li>
                                                <li><a href="/project/33/67">无人售货</a></li>
                                                <li><a href="/project/33/68">炒货</a></li>
                                                <li><a href="/project/33/69">办公用品</a></li>
                                                <li><a href="/project/33/70">生鲜</a></li>
                                                <li><a href="/project/33/71">电子烟</a></li>
                                                <li><a href="/project/33/72">快时尚百货</a></li>
                                                <li><a href="/project/33/73">散酒</a></li>
                                                <li id="more">显示更多...</li>
                    </div>
                </div>
    ...
    <script type=text/javascript>
        $(function() {  
            ...
            $("#redirect").click(function(){
              var page = $("#pages").val();
              console.log(page)
              window.location.href = "/project/33/73?page="+page;
            });
